...
# File name: vtidss_ml_rev_pre_dnn_rel_0.006.3.py
# Method: DNN
# Date: 23/10/2019
...
debug=0
filename = 'vtidss_ml_rev_pre_dnn_dev_006.3.py'
...
chart.savefig("./006-3_DNN_inputdata.png")
...
plt.savefig('./006-3_DNN_loss_by_lrs.png')
...
chart.savefig("./006-3_DNN_mae_by_window_size.png")
...
chart.savefig("./006-3_DNN_loss_of_best_lrs.png")
...
chart.savefig("./006-3_DNN_loss_of_best_lrs_from_epoch10.png")
...
chart.savefig("./006-3_DNN_Predict.png")
...
cwd = os.getcwd()
print (cwd)
model_path = "../../release/ml_hlc_rev_pre_dnn_0.006.3"
...
chart1.savefig("./006-3_DNN_Predict_checkloadmodel.png")
