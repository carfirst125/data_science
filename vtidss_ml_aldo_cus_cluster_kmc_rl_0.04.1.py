##############################################################
# ML MODEL FIND THE CS GROUP by PRODUCT CATEGORY
# File name: vtidss_ml_aldo_cus_cluster_kmc_rl_0.04.1.py
# Version: 0.04.1
# Previous version: 0.04.0
# Method: K-Mean Cluster 
# Date: 11/11/2019
# Author: Nhan Thanh Ngo
# Company: VTI-DSS
# Description: 
#    Cluster based on ALDO data in product dimension
#
# Status: Release
#
# Specification:
#    - input: datafile with customer id, rfm_group and purchase products
#    - output: ./0_04_1_output/
#          Three main files: 0_04_1_aldo_cus_cluster_by_product_short.csv
#                            0_04_1_aldo_group_cluster_info.csv
#							 0_04_1_aldo_group_cluster_summary.csv
#
# Command: python vtidss_ml_aldo_cus_cluster_kmc_dev_0.04.1.py -k N
...
try:
  opts, _ = getopt.getopt(sys.argv[1:], 'k:d:dh:', ['kcluster=', 'debug'])
...
# create debug folder
debug_path = "./"+version+"_debug"
#debug_path_k = "./"+version+"_debug/k_"+str(kcluster)+"_"+str(groupx)
...
sql = """
    SELECT * 
    FROM `Aldo.rfm_segment_by_behavior`
	"""
